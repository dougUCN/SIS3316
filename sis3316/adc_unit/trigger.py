...
class Adc_trigger(object):
    ...
    # Param fields: mask, offset, reg, doc
    _auto_properties = {
        ...
        "maw_gap_time": Param(
            0xFFF, 12, FIR_TRIGGER_SETUP_REG, """ Gap time (flat time)."""
        ),
        "maw_tau_factor": Param(
            0x3F, 24, FIR_TRIGGER_SETUP_REG, """ Tau factor. Valid value 0 -> 63"""
        ),
        "maw_tau_table": Param(
            0b11, 30, FIR_TRIGGER_SETUP_REG, """ Select the tau table. 0,1,2,3."""
        ),
        ...
        "threshold": Param(
            ...
            """ Trapezoidal threshold value. \nThe full 27-bit running sum + 0x800 0000
              is compared to this value to generate trigger.""",
        ),
        "cfd_ena": Param(
            0b11,
            28,
        ...
        "high_suppress_ena": Param(
            ...
            30,
            FIR_TRIGGER_THRESHOLD_REG,
            """A trigger will be suppressed if the running sum of the trapezoidal filter 
            goes above the value of the High Energy Threshold register. 
        ...
        "high_threshold": Param(
            ...
            """ The full 27-bit running sum + 0x800 0000 is compared 
            to the High Energy Suppress threshold value. 
